...
Sommet::Sommet(short value, int count) : value{value}, count{count} {}

Sommet::Sommet(Sommet *left, Sommet *right) : count{0}, value{-1}
{
...
short Sommet::getValue() { return value; }
...
void Sommet::setValue(short value) { this->value = value; }
